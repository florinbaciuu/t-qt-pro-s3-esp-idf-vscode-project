...
#define LV_COLOR_DEPTH 16 //originl 16
...
#define LV_DISP_DEF_REFR_PERIOD 16      /*[ms]*/  //original 16

/*Input device read period in milliseconds*/
#define LV_INDEV_DEF_READ_PERIOD 30     /*[ms]*/ //original 30
...
#define LV_DRAW_COMPLEX 1
    ...
    *Caching has LV_SHADOW_CACHE_SIZE^2 RAM cost*/
    #define LV_SHADOW_CACHE_SIZE 4 //original 0
 ...
 *0 mean no caching.*/
#define LV_GRAD_CACHE_DEF_SIZE 0 // original 0
...
#define LV_USE_CALENDAR   1
    ...
    #define LV_CALENDAR_WEEK_STARTS_MONDAY 1
        ...
        #define LV_CALENDAR_DEFAULT_DAY_NAMES {"Lu", "Ma", "Mi", "Jo", "Vi", "Sa", "Du"}
    #else
        #define LV_CALENDAR_DEFAULT_DAY_NAMES {"Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"}
    #endif

    //#define LV_CALENDAR_DEFAULT_MONTH_NAMES {"January", "February", "March",  "April", "May",  "June", "July", "August", "September", "October", "November", "December"}
    #define LV_CALENDAR_DEFAULT_MONTH_NAMES {"Ianuarie", "Februarie", "Martie",  "Aprilie", "Mai",  "Iunie", "Iulie", "August", "Septembrie", "Octombrie", "Noiembrie", "Decembrie"}
